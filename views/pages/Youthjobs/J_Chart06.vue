<template>
    <!-- <div id="jChart06" style="width: 100%" ref="jChart06"></div> -->
    <div style="width: 100%; height: 100%" ref="jChart06Wrap">
        <div ref="jChart06" id="jChart06" style="width: 100%; height: 100%; background: #ffffff"></div>
    </div>
</template>
...
export default {
    ...
    methods: {
        createChart: function () {
            ...
            for (let i = 0; i < storage.length; i++) {
                if (storage[i]["lclas_code"] == this.typeCode) {
            ...
            if (COMMON_UTIL.isEmpty(this.charts["jChart06"]) == false) {
                this.charts["jChart06"].dispose();
            }

            let chartWarp = this.$refs["jChart06Wrap"];
            chartWarp.innerHTML = "";
    ...
    watch: {
        ...
        chartData: function (newValue, oldValue) {
            // console.log('jChart06 watch: ', newValue, oldValue);
            // 차트 생성 함수
            this.createChart();
        },

        "typeCode": function (newValue, oldValue) {
            // console.log('jChart06 ageIndex: ', newValue, oldValue);
            // 차트 생성 함수
            this.createChart();
        },
    },
